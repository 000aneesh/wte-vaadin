...
import com.app.wte.ui.ProductForm.ProductFormFactory;
import com.app.wte.ui.SampleCrudLogic.SampleCrudLogicFactory;
...
public class SampleCrudView extends CssLayout implements View {
    ...
    @PostConstruct
    private void init() {
    	System.out.println("SampleCrudView entry");
